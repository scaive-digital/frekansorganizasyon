export interface Service {
    ...
    image: string;
    features: string[];
    category: 'wedding' | 'engagement' | 'henna' | 'corporate' | string;
}
...
export const services: Service[] = [
    {
        ...
        icon: "rings",
        image: "https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&q=80&w=2000", // Luxury chandelier tablescape
    ...
    },
    {
        ...
        icon: "moon",
        image: "https://images.unsplash.com/photo-1522413452208-996ff3f3e740?auto=format&fit=crop&q=80&w=2000", // Warm romantic lighting
    ...
    },
    {
        ...
        icon: "heart",
        image: "https://images.unsplash.com/photo-1469371670807-013ccf25f16a?auto=format&fit=crop&q=80&w=2000", // Elegant table setup
