            ...
            <div className="max-w-[96%] mx-auto px-4 md:px-8 relative z-10">
                ...
                <div className="flex flex-col gap-24 md:gap-40 w-full">
                    {galleryItems.map((item, index) => {
                        ...
                        // Determine sizing based on index to create a dynamic layout
                        const isGiant = index === 0 || index === 4; // Massive full width
                        const isPortrait = item.span?.row === 2; // Assuming original data marked portraits
